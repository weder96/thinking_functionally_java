...
public class A03ArrayListGenerics {
	...
	public static void IntegerAddNumber(){
		...
		/* This must not be allowed! The problem is avoided by noting that here
		 * the Substitution Principle does not apply:
		 * assignment on the fourth line is not allowed because
